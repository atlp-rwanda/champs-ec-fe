...
function Card({
  ...
  return (
    <div className="w-full max-w-48 mb-10 h-[17rem] flex flex-col gap-3 bg-white border border-gray-100 shadow relative">
      ...
      <div className="px-4 flex flex-col gap-1">
        <h5 className="max-w-1xl text-[12px] font-semibold tracking-tight text-gray-900">
