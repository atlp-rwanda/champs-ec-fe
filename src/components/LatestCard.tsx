    ...
    <div className="w-[300px] min-w-[300px] h-[350px] p-2 rounded-lg overflow-hidden shadow-sm ">
      ...
      >
        <div className=" bottom-0 left-0 pl-5 bg-opacity-50 w-full">
          <h1
            className={`${color ? color : 'text-white'} font-bold text-2xl text-[32px] mb-2`}
          >
            {name}
          </h1>
          <div className="flex gap-4">
            <p className={color ? color : 'text-white'}>Price:$ {price} </p>
            <p className={color ? color : 'text-white'}>Seller: {sellername}</p>
          </div>
        </div>
      </div>
    </div>
