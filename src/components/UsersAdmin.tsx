          ...
          <>
            <div className="w-[100%] sm:w-[70%] min-h-[600px] mx-auto mt-10 p-5 border border-primaryGrey shadow rounded-[10px]">
              {!data ? (
                ...
                <>
                  <h1 className="font-bold text-[20px] flex gap-1">
                    Users:
                  ...
                  <div className="w-[100%] sm:w-[80%] m-auto mt-9">
                    <table className="text-black border-t-1 text-left w-[100%] min-h-[300px] border-spacing-4">
